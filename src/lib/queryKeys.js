export const queryKeys = {
  ...
  research: {
    all: ['research'],
    discover: (category, search, sort) => [...queryKeys.research.all, 'discover', category, search, sort],
    mine: (userId, category, search, sort) => [...queryKeys.research.all, 'mine', userId, category, search, sort],
    saved: () => [...queryKeys.research.all, 'saved'],
